        ...
        <div className={styles.contentWrap}>
          ...
          <div className={styles.cardsWrap}>
            ...
            <div className={styles.courseCard}>
              <div className={styles.cardImgBox}>
                <img 
                  src="https://zhaoqiwangteaching-images.oss-cn-guangzhou.aliyuncs.com/markdown1.png" 
            ...
            <div className={styles.courseCard}>
              <div className={styles.cardImgBox}>
                <img 
                  src="https://zhaoqiwangteaching-images.oss-cn-guangzhou.aliyuncs.com/markdown2.png" 
            ...
            <div className={styles.courseCard}>
              <div className={styles.cardImgBox}>
                <img 
                  src="https://zhaoqiwangteaching-images.oss-cn-guangzhou.aliyuncs.com/markdown3.png" 
