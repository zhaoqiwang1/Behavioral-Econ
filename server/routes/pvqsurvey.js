...
const QUESTIONS = [
  ...
  { questionNumber: 2, questionText: "变得富有对TA 很重要。TA 想拥有很多钱和昂贵的东西。" },
  { questionNumber: 3, questionText: "TA 认为让世界上所有人都被平等对待很重要。TA 相信每个人都应拥有平等的生活机会。" },
  { questionNumber: 4, questionText: "展现自己的能力对TA 非常重要。TA 希望别人欣赏TA 所做的事。" },
  { questionNumber: 5, questionText: "生活在安全的环境中对TA 很重要。TA 避免任何可能危及自身安全的事物。" },
  { questionNumber: 6, questionText: "做生活中各种不同的事情对TA 很重要。TA 总是在寻找新鲜事物去尝试。" },
  { questionNumber: 7, questionText: "TA 认为人应该听从指示。TA 觉得即使没有人监督，也应该始终遵守规则。" },
  { questionNumber: 8, questionText: "倾听与自己不同的人对TA 很重要。即使不同意，TA 仍希望理解TA 们。" },
  { questionNumber: 9, questionText: "TA 认为不要贪求超过自己已有的东西很重要。TA 相信人应该满足于已有的一切。" },
  { questionNumber: 10, questionText: "TA 会抓住任何机会享受乐趣。做让自己快乐的事情对TA 很重要。" },
  { questionNumber: 11, questionText: "做决定时，TA 喜欢自己作主。TA 希望拥有规划及选择活动的自由。" },
  { questionNumber: 12, questionText: "帮助身边的人对TA 非常重要。TA 希望关心他人的幸福。" },
  { questionNumber: 13, questionText: "成功对TA 很重要。TA 喜欢给别人留下深刻印象。" },
  { questionNumber: 14, questionText: "保持国家安全对TA 非常重要。TA 认为国家必须警惕内外部的威胁。" },
  { questionNumber: 15, questionText: "TA 喜欢冒险，总是在寻找新的刺激。" },
  { questionNumber: 16, questionText: "行为得体对TA 很重要。TA 希望避免做任何被认为是错误的事。" },
  { questionNumber: 17, questionText: "掌控他人、下达指令对TA 很重要。TA 希望别人按照TA 的要求去做。" },
  { questionNumber: 18, questionText: "对朋友忠诚对TA 很重要。TA 愿意全心投入亲近的人。" },
  { questionNumber: 19, questionText: "TA 坚信人类应该关爱大自然。" },
  { questionNumber: 20, questionText: "宗教信仰对TA 很重要。TA 努力遵守宗教的要求。" },
  { questionNumber: 21, questionText: "保持整洁、有条理对TA 很重要。TA 非常不喜欢杂乱无章。" },
  { questionNumber: 22, questionText: "对事物保持好奇心对TA 很重要。TA 喜欢尝试理解各种不同的事物。" },
  { questionNumber: 23, questionText: "TA 相信世界所有人的生活应该和谐。促进各群体之间的和平对TA 很重要。" },
  { questionNumber: 24, questionText: "有抱负对TA 很重要。TA 想展现自己的能力。" },
  { questionNumber: 25, questionText: "TA 认为以传统方式做事最好。保持所学到的习俗对TA 很重要。" },
  { questionNumber: 26, questionText: "享受生活的乐趣对TA 很重要。TA 喜欢犒劳自己。" },
  { questionNumber: 27, questionText: "回应他人的需要对TA 很重要。TA 努力支持自己认识的人。" },
  { questionNumber: 28, questionText: "TA 认为应始终尊重父母和长者。服从对TA 来说很重要。" },
  { questionNumber: 29, questionText: "TA 希望所有人都被公正对待，即使是陌生人。保护社会弱势群体对TA 很重要。" },
  { questionNumber: 30, questionText: "TA 喜欢惊喜。拥有刺激的生活对TA 很重要。" },
